...
//     d3, d2_pre, ext bytes consumed, output words emitted
//   - all the stream content read (a3 long, a1 byte)
//
// Args derived from the MAME tap (mame_decoder_stream_tap.lua):
//   outAbs   = 0x400706
//   ctrlAbs  = 0x080650
//   extAbs   = 0x02BE18
//
...
// ─── Driver: warm state @ f12000, run 5 ticks, intercept first body decoder ────
