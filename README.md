...
| **Long demo oracle f12000..18000** | 🟡 checkpoint 2026-05-13: `npx tsc -b` PASS; playfield exact fino a f13200 dopo `FUN_1AD54 -> FUN_2BC5C -> FUN_2FF40` slapstic prefetch side-effect, fix A3/A4 `FUN_160F6`, wiring HUD/banner di `FUN_10504`, `FUN_253EC` JT[4] eaten-orbit e `FUN_29CCE` tag `0x1f` side-wall bounce; rebuild chunk cadence step-1 allineata sui principali eventi f12899/f12911/f12920/f12931/f12940/f12945/f12950/f12951; mode0→mode1→mode2 handoff riallineato anche nel secondo cycle f15367..f15379; scroll-range spawn `FUN_10504` riallinea gli script slot 0..12 del secondo cycle; `FUN_1A9CC` scrive ora nell'intera video window playfield/sprite/alpha; residuo f13920 totale 146 byte storico / 167 fresh bank-aware, pfRam 0 byte |
