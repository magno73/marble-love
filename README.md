...
**Checkpoint recente (2026-05-14):** il timer presentation del segmento 4 ora
usa il valore MAME `45` (`0x002d`) invece del default `60`, senza cambiare
cadence o PF. Riduce il dense segment-5 `11460 -> 11352`, il tail fresh
`29193 -> 29070`, lo step10 fresh `15742 -> 15727` e il legacy storico
`145116 -> 144786`; resta aperto il residuo sprite/workRam da pagina MO
sporcata durante il micro-cadence mode2 segment-4.
