...
replica anche la visibilita' hi-score/PF tra f17010 e f17012: `helper11FF8`
atterra nel completion stage invece che nello stage 7, e il `tilemapBlit17044`
del segment 4 viene esposto un vblank dopo. Il fresh f16990..f17025 scende
`10874 -> 10335`; f17010 `562 -> 257` con `alpha 296 -> 0` e f17011
`563 -> 329` con `PF 234 -> 0`, mentre dense/tail segment-5 restano invariati
(`11352` / `29070`) e step10 fresh resta `15727`.
