...
replica anche il micro-ordine f17009/f17010: i counter visibili seguono la
fase MAME e il blocco banner/clear/vblank dello stage 6 viene piegato nello
stage 7 senza ritardare il completion del mode2. Il fresh f16990..f17025
scende `11252 -> 10874`; f17009 `580 -> 227` con `color 344 -> 0`, mentre
dense/tail segment-5 restano invariati (`11352` / `29070`) e step10 fresh
resta `15727`.
