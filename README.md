...
**Checkpoint recente (2026-05-14):** il reset mode2 del segmento 4 ora mostra
anche il banner alpha ROM `BONUS FOR / REMAINING / TIME` nel vblank f17004.
Il fresh f16990..f17025 scende `11568 -> 11464` e f17004 `295 -> 209`
(`alpha 86 -> 0`), senza regressioni su dense/tail segment-5 (`11352` /
`29070`) o step10 fresh (`15727`).
