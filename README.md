...
**Checkpoint recente (2026-05-14):** il reset mode2 del segmento 4 ora
replica anche il clear alpha parziale di f17005: dopo il banner ROM `BONUS
FOR / REMAINING / TIME` a f17004, lo stage 2 cancella solo le prime 18
righe alpha. Il fresh f16990..f17025 scende `11464 -> 11252`; f17005
`410 -> 198` con `alpha 212 -> 0`, senza regressioni su dense/tail
segment-5 (`11352` / `29070`) o step10 fresh (`15727`).
